...
if (isset($_POST["submit_produit"])) {
    ...
    if (isset($stmt)) {
        echo "<p class='success-message'>Auction item added successfully!</p>
";
    } 
}
...
<script>
  ...
  gtag('config', 'G-RMTZ216R9L');
    ...
    <link rel="stylesheet" href="../css/add__Auction.css">
</head>
<style>
  .success-message {
  font-size: 20px;
  ...
  padding: 10px 20px;
  background-color: #e9f7e3; /* Light green background */
  border: 2px solid #28a745; /* Green border */
  border-radius: 10px;
  max-width: 400px;
  margin: 20px auto;
  box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);
  animation: fadeInAndDisappear 5s ease-in-out forwards;
}
    ...
    <div class="container">
        ...
        <form id="addItemForm" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" maxlength="10" id="productName" name="productName" placeholder="Enter product name" >
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="productDescription" maxlength="50" name="productDescription" placeholder="Enter a detailed description including condition, specifications, year of manufacture, etc..." ></textarea>
            </div>
